...
class MainActivity : AppCompatActivity() {
    ...
    private val gameNames = arrayOf("Ratchet And Clank Rift Apart","DeathLoop","Resident Evil Village","Mass Effect Remake","Chivalry 2","Operation Tango","Mario Golf: Super Rush","Days Gone(PC)")
    private val gameDescription = arrayOf("Third Person PS5 Exclusive", "First Person PS5 Exclusive", "First Person Horror Game All Platforms", "Third Person RPG","First Person Fighting Game All Platforms","Co Operative Puzzle Game All Platforms","Party Sports Game Switch Only","Third Person Survival Game PC Release" )
